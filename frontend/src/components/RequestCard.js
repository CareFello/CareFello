                    ...
                    <Grid item xs={11} className='cardExpand'>
                        ...
                        <div className="additional-info">
                            ...
                            <ul>
                                ...
                                <Button className='btn' style={{textTransform: "lowercase",  backgroundColor: "#E48586", fontWeight: "bold", marginRight: "8px", marginLeft: "30px", marginTop: "20px", color: "white", borderRadius: "20px", boxShadow: "0px 4px 6px rgba(0, 0, 0, 0.1)" }}>Reject</Button>
                                <Button className='btn' style={{textTransform: "lowercase",  backgroundColor: "#05445E", fontWeight: "bold", marginRight: "8px", marginTop: "20px", color: "#D4F1F4", borderRadius: "20px", boxShadow: "0px 4px 6px rgba(0, 0, 0, 0.1)"}}>Continue</Button>
                            </ul>
                        </div>
                    </Grid>
                </Grid>
