...
var ReactSelectionPopup = function (_a, ref) {
    var onSelect = _a.onSelect, onClose = _a.onClose, children = _a.children, selectionClassName = _a.selectionClassName, _b = _a.multipleSelection, multipleSelection = _b === void 0 ? true : _b, metaAttrName = _a.metaAttrName, _c = _a.offsetToLeft, offsetToLeft = _c === void 0 ? 0 : _c, _d = _a.offsetToTop, offsetToTop = _d === void 0 ? 0 : _d, rest = tslib_1.__rest(_a, ["onSelect", "onClose", "children", "selectionClassName", "multipleSelection", "metaAttrName", "offsetToLeft", "offsetToTop"]);
    var _e = (0, react_1.useState)({ width: 0, height: 0 }), size = _e[0], setSize = _e[1];
    var _f = (0, react_1.useState)(null), position = _f[0], setPosition = _f[1];
    var popupRef = (0, react_1.useRef)(null);
    var positionRef = (0, react_1.useRef)(null);
    positionRef.current = position;
    var isPopupContent = (0, react_1.useCallback)(function (e) {
        var node = e.target;
    ...
    return (react_1.default.createElement("div", { style: { position: 'fixed', left: left, top: top, zIndex: 9999 } },
        react_1.default.createElement("div", tslib_1.__assign({ ref: popupRef }, rest), children)));
};
exports.default = react_1.default.forwardRef(ReactSelectionPopup);
